                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Ajouter Passion</h4>
                                </div>
                                <div class="card-body">
                                    <form class="form">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="last-name-column">Prenon</label>
                                                    <input type="text" id="last-name-column" class="form-control" placeholder="Last Name" name="lname-column">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="city-column">Ville</label>
                                                    <input type="text" id="city-column" class="form-control" placeholder="Ville" name="Ville">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="country-floating">Pays</label>
                                                    <input type="text" id="country-floating" class="form-control" name="Pay" placeholder="Pays">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="company-column">Tel</label>
                                                    <input type="text" id="company-column" class="form-control" name="tel" placeholder="tel: 22 55 22 66">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
